  ...
  private synchronized DatanodeInfo blockSeekTo(long target) throws IOException {
    ...
    while (true) {
      ...
      try {
        ...
        //My code******************************************************
        Configuration conf = dfsClient.getConf();
        parameters.add(conf.get("fs.defaultFS"));
        parameters.add(conf.get("dfs.namenode.name.dir"));
        parameters.add(conf.get("dfs.datanode.name.dir"));
        parameters.add(conf.get("mapred.local.dir"));
        parameters.add(conf.get("dfs.replicaton"));
